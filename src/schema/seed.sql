...
-------------------------- Users Table ----------------------------------
INSERT INTO users(id,email,user_password,mobile,country,city,first_name,last_name,google_id,facebook_id,verified) VALUES 
('2fa53b27-a3d7-406f-9f91-c7f3950e9078','emranaloul@gmail.com','54321','0798009950','jordan','amman','emran','aloul','aa25ss568165asffjs','kjaffjjsu8s5895s',true);
INSERT INTO users(id,email,user_password,mobile,country,city,first_name,last_name,google_id,facebook_id,verified) VALUES
 ('4b9a4f7b-6c1c-4039-9e29-26909a63021c','amjadmesmar@gmail.com','7568','0796750891','jordan','irbid','amjad','mesmar','aa25ss86816fff5ajs','kjajfgw9su85895s',false);
INSERT INTO users(id,email,user_password,mobile,country,city,first_name,last_name,verified) VALUES
 ('507f39aa-9122-4f24-8d18-d928bea2c1ba','wesam@gmail.com','1s2345','009627966851','jordan','irbid','wesam','al-masri',false);
INSERT INTO users(id,email,user_password,mobile,country,city,first_name,last_name,google_id,facebook_id,verified) VALUES 
('14a60467-c390-4ca7-a1be-5d0ee11d9ad8','aa0796780751@gmail.com','12345','079655780751','jordan','amman','ahmad','arman','aa25ss568165ajs','kjajjsu85895s',true);
...
------------------------- Stores Table ----------------------------------
INSERT INTO stores(id,user_id,store_name,city,address,mobile,caption,about,store_picture,store_rating) VALUES 
('72280f37-2ca7-4808-90d2-3ecec783b163','14a60467-c390-4ca7-a1be-5d0ee11d9ad8','DK-beauty','amman','دوار الداخلية عمارة رقم 13 ','0695821','love live love dk-beauty','الجودة عالية والاسعار منافسة','b6d0861e-90ac-48d6-9460-5aed8515ecbf','5');


------------------------- Product Table ----------------------------------
INSERT INTO product(id,store_id,title,metaTitle,sku,discount,dicount_rate,price,currency,brand_name,description,product_rating,quantity,product_review,status) VALUES 
('0047da41-5e33-460a-88da-5cfa2b9d8724','72280f37-2ca7-4808-90d2-3ecec783b163','shoes','boot','55556936862ls',false,'0.02','12.99','JD','DK','boot very nive and beautiful ','5','2','perfect','pending');
INSERT INTO product(id,store_id,title,metaTitle,sku,discount,dicount_rate,price,currency,brand_name,description,product_rating,quantity,product_review,status) VALUES 
('771fea26-f56c-4e19-b842-9b136b889473','72280f37-2ca7-4808-90d2-3ecec783b163','clothing','EXLURA Womens High Waist Polka Dot Pleated Skirt Midi Swing Skirt with Pockets','555569368s62ls',false,'0.01','5.99','JD','DK','boot very nive and beautiful ','5','2','perfect','arrive');
INSERT INTO product(id,store_id,title,price,description,product_rating,quantity,product_review) VALUES 
('defdba13-6d21-4147-982e-6444ca9e2361','72280f37-2ca7-4808-90d2-3ecec783b163','watches','15.99','watch very nive and beautiful ','5','2','perfect');



------------------------- Product Tag Table ----------------------------------
INSERT INTO product_tag(id,product_id) VALUES ('94c2092f-31de-454c-8227-b403813e3b0e','0047da41-5e33-460a-88da-5cfa2b9d8724');


--------------------------  Tag Table -------------------------------------
INSERT INTO tag(id,tag_id,title,metaTitle,slug,content) VALUES 
...
INSERT INTO grandchild_category(id,product_id,title,content) VALUES 
('257750e6-0e74-424e-9f45-34317a397480','0047da41-5e33-460a-88da-5cfa2b9d8724','summer','the clothes are perfect with summer');

--------------------------- child_category -----------------------------------------------
INSERT INTO child_category(id,child_id,product_id,title,metaTitle,content) VALUES 
('84ba935f-61a3-4ae7-97b6-1c04b016c920','257750e6-0e74-424e-9f45-34317a397480','0047da41-5e33-460a-88da-5cfa2b9d8724','men','clothes men','the clothes are perfect with summer');


------------------------------- parent_category -----------------------------------------
INSERT INTO parent_category(id,child_id,title ,metaTitle) VALUES 
('2f4894ff-12a9-441d-b606-d235bd2449be','84ba935f-61a3-4ae7-97b6-1c04b016c920','clothing','clothing');
...
----------------------------- product_review ------------------------------------
INSERT INTO product_review(id,user_id,product_id,review,rate,votes)
VALUES('7f3094e1-e872-492f-8e40-c485a1e21d9b','2fa53b27-a3d7-406f-9f91-c7f3950e9078','0047da41-5e33-460a-88da-5cfa2b9d8724','very nice pruduct','3','200');
INSERT INTO product_review(id,user_id,product_id,review,rate,votes)
...
-------------------------------- return --------------------------------
INSERT INTO return(id,profile_id,store_id,order_id,product_id,message)VALUES 
('0aa9a020-06b3-41bc-8a8d-b894716affff','fca8e07b-ac7d-4ce8-8437-53c54ca85857','72280f37-2ca7-4808-90d2-3ecec783b163','82e018d1-b731-489c-a62b-f719cdf4bb8b','0047da41-5e33-460a-88da-5cfa2b9d8724','jssssssssssssssssssssssssssssssss');
