...
const routes = [...orderRoutes, ...accountRoutes]
// Global middleware
// router.use(bearer);
...
router.delete('/store', bearer, checkAuth, upload.none(), deleteStoreHandler);
...
router.get('/products/search', upload.none(), productSearchHandler)
//tag
...
router.delete('/account/delete', bearer, upload.none(), deleteAccountHandler)
