...
module.exports = { signup, signupGoogle, createProfile, getUserById, getUserByGoogleId, getUserByEmail, getUserByMobile ,updateUserVerification,getUserIdFromToken,getMobileById,getProfileByUserId}